...
function viewFinishedJob() {
    window.location.href = '127.0.0.1:8090/home/done';
}
...
async function sendRequestJob() {
    try {
        fetch('127.0.0.1:8090/api/view/model/training/all', {
            method: 'GET',
...
async function sendRequestData() {
    ...
    try {
        fetch('127.0.0.1:8090/api/view/model/training/all' + query, {
            method: 'GET',
            headers: { 'Content-Type': 'application/json' },
        })
            .then(async response => {
...
async function sendRequestModelDetail(modelId) {
    try {
        fetch('127.0.0.1:8090/api/view/model/training/' + modelId, {
            method: 'GET',
            headers: { 'Content-Type': 'application/json' },
        })
            .then(async response => {
